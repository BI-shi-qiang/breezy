...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wp(e,t,n){let r=new Float32Array(up),i=new J(0,1,0);return new Kd({name:`SphericalGaussianBlur`,defines:{n:up,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Dp(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Tp(){return new Kd({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Dp(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ep(){return new Kd({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Dp(),fragmentShader:`
	...
	`}var Op=class extends tl{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Od([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var $m={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function eh(e,t){let n=$m[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var th=new J;function nh(){return X.getLuminanceCoefficients(th),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${th.x.toFixed(4)}, ${th.y.toFixed(4)}, ${th.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
